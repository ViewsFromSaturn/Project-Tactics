...
public class AbilityInfo
{
	...
	public int EtherCost, Power, Range, RtCost;
	public string TargetType; // "Single","AOE Diamond","Self"
	...
	public static List<AbilityInfo> GetTestAbilities() => new()
	{
		...
		new() { Name="Healing Region", Icon="♥", Category="heal",  Description="Creates a zone that heals allies over 3 turns.",       EtherCost=50, Power=25, Range=4, RtCost=30, TargetType="AOE Diamond", IsUsable=false },
